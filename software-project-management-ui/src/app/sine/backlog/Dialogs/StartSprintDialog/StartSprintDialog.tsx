...
const StartSprintDialog: React.FC<{ project: any; sprint: any; callUpdate: () => void }> = ({
    project,
    sprint,
    callUpdate,
}) => {
    ...
    const handleClickOpen = () => {
        ...
        console.log(sprint?.status?.toString() == "created" ? "Start Sprint" : "Complete Sprint");
        setOpen(true);
    };
    ...
    const [startDate, setStartDate] = useState<Dayjs | null>(dayjs(sprint?.startDate) || dayjs());
    const [endDate, setEndDate] = useState<Dayjs | null>(dayjs(sprint.endDate) || null);
            ...
            >
                ...
                <DialogContent sx={{ width: "500px" }}>
                    ...
                    >
                        {!isReadonly ? (
                            <>
                                <strong style={{ color: "green" }}>{sprint?.issues?.length}</strong>{" "}
