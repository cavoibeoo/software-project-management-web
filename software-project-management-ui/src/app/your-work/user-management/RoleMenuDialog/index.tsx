...
const RoleMenuDialog = ({ project, callUpdate }: { project: any; callUpdate: () => void }) => {
    const [open, setOpen] = useState(false);
    const [selectedRole, setSelectedRole] = useState<string | null>(project?.roles[0].name);
    const [currentRoleId, setCurrentRoleId] = useState<string | null>(project?.roles[0]._id);
    ...
    return (
        <>
            ...
            >
                <AppBar sx={{ position: "relative", backgroundColor: "#283045 !important" }}>
                    <Toolbar>
                        <IconButton
                            edge="start"
                            color="inherit"
                        ...
                        <Button autoFocus color="inherit" onClick={() => setIsUpdateRoleName(true)}>
                            update role name
                        </Button>
                        <Button autoFocus color="inherit" onClick={() => setIsDeleteRole(true)}>
                            delete role
                        </Button>
                            ...
                            >
                                ...
                                <Box sx={{ display: "flex", flexDirection: "column" }}>
                                    ...
                                    <Button
                                        ...
                                        sx={{
                                            mb: 1,
                                            backgroundColor: "#1c93ee94 !important",
                                        }}
                                    >
                                        + ADD
                                    </Button>
            ...
            <Dialog open={isUpdateRoleName} onClose={() => setIsUpdateRoleName(false)}>
                <AppBar sx={{ position: "relative", backgroundColor: "#283045 !important" }}>
                    <Toolbar>
                        <IconButton
                            edge="start"
