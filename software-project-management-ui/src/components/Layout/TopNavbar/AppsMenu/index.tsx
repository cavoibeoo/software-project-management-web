...
import styles from "@/components/Layout/TopNavbar/sineMenu/sineMenu.module.css";
import { IconButton, Typography, Tooltip, Menu } from "@mui/material";

const sineMenu: React.FC = () => {
	...
	return (
		<>
			<Tooltip title="sine">
				...
				>
					<i className="material-symbols-outlined">sine</i>
				</IconButton>
			</Tooltip>
			...
			>
				<ul className={styles.sineMenuList}>
					<li>
