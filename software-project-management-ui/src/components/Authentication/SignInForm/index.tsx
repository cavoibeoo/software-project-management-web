...
import { Grid, Button, Box, Typography, FormControl, TextField, IconButton } from "@mui/material";
        ...
        <>
            <Box
                ...
                sx={{
                    ...
                    backgroundImage: "url('/images/authentication/LoginBackground_darkTheme.jpg')",
