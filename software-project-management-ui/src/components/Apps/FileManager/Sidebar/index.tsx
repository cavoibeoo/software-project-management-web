			...
			>
				<Box sx={{ padding: { xs: "20px", sm: "25px" } }}>
					...
					<ul className={styles.sidebarMenu}>
						<li>
							<Link
								href="/sine/file-manager/"
								className={`link ${
									pathname === "/sine/file-manager/" ? `${styles.active}` : ""
								}`}
							>
							...
							<ul className="list-unstyled">
								<li>
									<Link
										href="/sine/file-manager/assets/"
										className={`link ${
											pathname === "/sine/file-manager/assets/"
												? `${styles.active}`
												: ""
										}`}
									>
								...
								<li>
									<Link
										href="/sine/file-manager/projects/"
										className={`link ${
											pathname === "/sine/file-manager/projects/"
												? `${styles.active}`
												: ""
										}`}
									>
								...
								<li>
									<Link
										href="/sine/file-manager/personal/"
										className={`link ${
											pathname === "/sine/file-manager/personal/"
												? `${styles.active}`
												: ""
										}`}
									>
								...
								<li>
									<Link
										href="/sine/file-manager/applications/"
										className={`link ${
											pathname === "/sine/file-manager/applications/"
												? `${styles.active}`
												: ""
										}`}
									>
						...
						<li>
							<Link
								href="/sine/file-manager/documents/"
								className={`link ${
									pathname === "/sine/file-manager/documents/"
										? `${styles.active}`
										: ""
								}`}
							>
						...
						<li>
							<Link
								href="/sine/file-manager/media/"
								className={`link ${
									pathname === "/sine/file-manager/media/"
										? `${styles.active}`
										: ""
								}`}
							>
						...
						<li>
							<Link
								href="/sine/file-manager/recents/"
								className={`link ${
									pathname === "/sine/file-manager/recents/"
										? `${styles.active}`
										: ""
								}`}
							>
						...
						<li>
							<Link
								href="/sine/file-manager/important/"
								className={`link ${
									pathname === "/sine/file-manager/important/"
										? `${styles.active}`
										: ""
								}`}
							>
